 ...
 * under the License.
 */
package com.taobao.yinggang.curatorexample.leader;
...
public class LeaderSelectorExample {
	...
	private static final String PATH = "/example-test-yinggang/leader";
	...
	public static void main(String[] args) throws Exception {
		...
		try {
			for (int i = 0; i < CLIENT_QTY; ++i) {
				CuratorFramework client = CuratorFrameworkFactory.newClient("10.125.193.148:2181,10.125.192.53:2181,10.232.102.191:2181",
